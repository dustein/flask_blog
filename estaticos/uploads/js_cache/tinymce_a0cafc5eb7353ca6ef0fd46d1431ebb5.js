var tinyMCEPreInit = { settings : { themes : "advanced", plugins : "safari,inlinepopups,autosave,spellchecker,paste,wordpress,media,fullscreen,wpeditimage", languages : "pt", debug : false }, base : "http://www.casodepolicia.com/wp-includes/js/tinymce", suffix : "", query : "ver=311" };tinyMCEPreInit.start = function() {
...
clipboard_msg:"Copiar/Recortar/Colar não está disponível no Mozilla ou Firefox.",
clipboard_no_support:"Não suportado pelo seu navegador no momento; use os atalhos de teclado.",
popup_blocked:"Desculpe, mas percebemos que o seu bloqueador de popup desabilitou uma janela que fornece funcionalidades do aplicativo. Você precisará desabilitar o bloqueio de popup neste site para usar esta ferramenta de forma completa.",
invalid_data:"Erro: os valores marcados em vermelho são inválidos.",
...
day_long:"domingo,segunda-feira,terça-feira,quarta-feira,quinta-feira,sexta-feira,sábado",
...
forward_desc:"Para frente",
backward_desc:"Para trás",
absolute_desc:"Ativar/desativar posicionamento absoluto",
content:"Novo layer..."
},
save:{
save_desc:"Salvar",
...
nonbreaking:{
nonbreaking_desc:"Inserir espaço sem quebra de linha"
},
iespell:{
iespell_desc:"Conferir ortografia",
download:"O ieSpell não foi detectado. Quer instalar agora?"
},
advhr:{
...
paste_dlg:{
text_title:"Use CTRL+V no seu teclado para colar o texto nesta janela.",
text_linebreaks:"Manter quebras de linha",
word_title:"Use CTRL+V no seu teclado para colar o texto nesta janela."
},
table:{
...
split_cells_desc:"Dividir células mescladas",
merge_cells_desc:"Mesclar células",
row_desc:"Propriedades da linha da tabela",
cell_desc:"Propriedades da célula da tabela",
props_desc:"Propriedades da tabela",
paste_row_before_desc:"Colar linha da tabela antes",
paste_row_after_desc:"Colar linha da tabela depois",
...
autosave:{
unload_msg:"As modificações que você fez serão perdidas se você sair desta página."
},
fullscreen:{
desc:"Ativar/desativar modo de tela inteira (Alt+Shift+G)"
},
media:{
...
visualchars:{
desc:"Caracteres de controle visual ligados/desligados"
},
spellchecker:{
desc:"Ativar/desativar verificação ortográfica (Alt+Shift+N)",
menu:"Configurações da verificação ortográfica",
ignore_word:"Ignorar palavra",
ignore_words:"Ignorar todas",
langs:"Idiomas",
wait:"Por favor, aguarde...",
sug:"Sugestões",
no_sug:"Nenhuma sugestão",
no_mpell:"Sem erros de ortografia"
},
pagebreak:{
...
bold_desc:"Negrito (Ctrl / Alt+Shift + B)",
italic_desc:"Itálico (Ctrl / Alt+Shift + I)",
underline_desc:"Sublinhado",
striketrough_desc:"Riscado (Alt+Shift+D)",
justifyleft_desc:"Alinhar à esquerda (Alt+Shift+L)",
justifycenter_desc:"Centralizar (Alt+Shift+C)",
justifyright_desc:"Alinhar à direita (Alt+Shift+R)",
justifyfull_desc:"Justificar (Alt+Shift+J)",
bullist_desc:"Lista não ordenada (Alt+Shift+U)",
...
link_desc:"Inserir/editar link (Alt+Shift+A)",
link_delta_width:"0",
link_delta_height:"0",
unlink_desc:"Remover link (Alt+Shift+S)",
image_desc:"Inserir/editar imagem (Alt+Shift+M)",
image_delta_width:"0",
image_delta_height:"0",
cleanup_desc:"Limpar código bagunçado",
...
charmap_desc:"Inserir símbolo",
visualaid_desc:"Ativar/desativar elementos invisíveis",
...
help_desc:"Ajuda",
blockquote_desc:"Aspas (Alt+Shift+Q)",
clipboard_msg:"Copiar/Recortar/Colar não está disponível no Mozilla ou Firefox.",
path:"Caminho",
newdocument:"Tem certeza que quer apagar todo o conteúdo?",
toolbar_focus:"Ir para ferramentas - Alt+Q, ir para editor - Alt+Z, ir para caminho de um elemento - Alt+X",
more_colors:"Mais cores",
...
code_title:"Editor de HTML",
code_wordwrap:"Quebra automática",
colorpicker_title:"Escolher uma cor",
colorpicker_picker_tab:"Seletor",
colorpicker_picker_title:"Seletor de cor",
...
charmap_title:"Selecionar caractere especial",
...
link_target_blank:"Abrir link numa nova janela",
link_titlefield:"Título",
link_is_email:"O URL que você indicou parece ser um endereço de email. Você quer adicionar o prefixo mailto: necessário?",
link_is_external:"O URL que você digitou parece ser um link externo. Quer adicionar o prefixo http://?",
...
bgcolor:"Fundo",
base:"Base",
flashvars:"Variáveis do Flash (Flashvars)",
...
correction:"Nenhuma correção",
enablejavascript:"Ativar JavaScript",
starttime:"Hora de início",
endtime:"Fim",
href:"Href",
qtsrcchokespeed:"Limite de velocidade",
target:"Destino",
volume:"Volume",
...
mute:"Mudo",
stretchtofit:"Aumentar para ajustar ao tamanho",
...
maintainaspect:"Manter aparência",
nojava:"Sem java",
...
swstretchstyle:"Estilo do alargamento",
swstretchhalign:"Aumentar alinhamento horizontal",
swstretchvalign:"Aumentar alinhamento vertical",
sound:"Som",
progress:"Andamento",
qtsrc:"QT Src",
qt_stream_warn:"Fluxos de recursos rtsp devem ser adicionados ao campo QT Src, na guia Avançadas.",
align_top:"Topo",
align_right:"Direita",
align_bottom:"Base",
align_left:"Esquerda",
align_center:"Centro",
align_top_left:"Em cima à esquerda",
align_top_right:"Em cima à direita",
align_bottom_left:"Embaixo à esquerda",
align_bottom_right:"Embaixo à direita",
flv_options:"Opções de Flash Vídeo",
...
flv_jscallback:"Callback JS"
});

tinyMCE.addI18n("pt.wordpress",{
wp_adv_desc:"Mostrar/ocultar opções avançadas (Alt+Shift+Z)",
wp_more_desc:"Inserir a tag Mais (more) (Alt+Shift+T)",
wp_page_desc:"Inserir quebra de página (Alt+Shift+P)",
wp_help_desc:"Ajuda (Alt+Shift+H)",
wp_more_alt:"Mais...",
wp_page_alt:"Próxima página...",
...
tinyMCE.addI18n("pt.wpeditimage",{
edit_img:"Editar imagem",
del_img:"Excluir imagem",
adv_settings:"Configurações avançadas",
none:"Nenhuma",
size:"Tamanho",
thumbnail:"Miniatura",
medium:"Médio",
full_size:"Tamanho completo",
current_link:"Link atual",
link_to_img:"Link para imagem",
link_help:"Digite o URL do link ou clique acima para as predefinições.",
adv_img_settings:"Configurações avançadas de imagem",
source:"Origem",
width:"Largura",
height:"Altura",
orig_size:"Tamanho Original",
css:"Classe CSS",
adv_link_settings:"Configurações avançadas de link",
link_rel:"Rel do Link",
height:"Altura",
orig_size:"Tamanho Original",
css:"Classe CSS",
s60:"60%",
...
s120:"120%",
s130:"130%",
img_title:"Editar título da imagem",
caption:"Editar descrição da imagem",
alt:"Editar o texto alternativo"
});
...
tinyMCE.init({mode:"none",onpageload:"wpEditorInit",width:"100%",theme:"advanced",skin:"wp_theme",theme_advanced_buttons1:"bold,italic,strikethrough,|,bullist,numlist,blockquote,|,justifyleft,justifycenter,justifyright,|,link,unlink,wp_more,|,spellchecker,fullscreen,wp_adv",theme_advanced_buttons2:"formatselect,underline,justifyfull,forecolor,|,pastetext,pasteword,removeformat,|,media,charmap,|,outdent,indent,|,undo,redo,wp_help",theme_advanced_buttons3:"",theme_advanced_buttons4:"",language:"pt",spellchecker_languages:"+English=en,Danish=da,Dutch=nl,Finnish=fi,French=fr,German=de,Italian=it,Polish=pl,Portuguese=pt,Spanish=es,Swedish=sv",theme_advanced_toolbar_location:"top",theme_advanced_toolbar_align:"left",theme_advanced_statusbar_location:"bottom",theme_advanced_resizing:"1",theme_advanced_resize_horizontal:"",dialog_type:"modal",relative_urls:"",remove_script_host:"",convert_urls:"",apply_source_formatting:"",remove_linebreaks:"1",paste_convert_middot_lists:"1",paste_remove_spans:"1",paste_remove_styles:"1",gecko_spellcheck:"1",entities:"38,amp,60,lt,62,gt",accessibility_focus:"",tab_focus:":next",content_css:"http://www.casodepolicia.com/wp-includes/js/tinymce/wordpress.css",save_callback:"switchEditors.saveCallback",wpeditimage_disable_captions:"",plugins:"safari,inlinepopups,autosave,spellchecker,paste,wordpress,media,fullscreen,wpeditimage"});